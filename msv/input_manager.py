...
DEFAULT_KEY_MAP = {
    ...
    "tiger_of_songyu": dic.DIK_V,
    "miracle_tonic": dic.DIK_END,
}

KEY2DISPLAY_NAME = {
    "jump": "Jump",
    "as_you_will_fan": "As You Will Fan",
    "ground_shattering_wave": "Earth: Ground-Shattering Wave",
    "stone_tremor": "Stone Tremor",
    "iron_fan_gale": "Heaven: Iron Fan Gale",
    "consuming_flames": "Consuming Flames",
    "gold_banded_cudgel": "Humanity: Gold-Banded Cudgel",
    "star_vortex": "Scroll: Star Vortex",
    "interact": "Interact",
    ...
    "wrath_of_gods": "Sage: Wrath of Gods",
    "tiger_of_songyu": "Scroll: Tiger of Songyu",
    "miracle_tonic": "Sage: Tai Yu's Miracle Tonic",
}
