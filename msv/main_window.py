...
from msv.util import get_config, save_config, GlobalHotKeyListener, play_sound, copy_ev_queue, resource_path
from msv.keybind_setup_window import KeyBindSetupWindow
...
class MainWindow(ttk.Frame):
    def __init__(self, master):
        ...
        self.log("MS-Visionify Kanna Ver v" + __version__)
        self.log('\n')
    ...
    def _on_preset_platform_set(self, __):
        ...
        path = resource_path + 'platform\\' + mapscripts.map2platform[preset] + '.platform'
    ...
    def set_platform_file(self, path):
        with open(path, "rb") as f:
            try:
                ...
                showerror(APP_TITLE, "Failed to load terrain file: %s\n%s" % (path, str(e)))
            else:
